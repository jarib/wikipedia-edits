...
module.exports = function () {
    ...
    parser.on('endElement', function (name) {
        ...
        if (name === 'revision') {
            stream.push({
                ...
                timestamp_string: currentRevision.timestamp,
    ...
    parser.on('text', function (text) {
        ...
        case STATE_REVISION_ID:
            currentRevision.id = currentRevision.id || '';
            currentRevision.id += text;
            break;
        case STATE_REVISION_TS:
            currentRevision.timestamp = currentRevision.timestamp || '';
            currentRevision.timestamp += text;
            break;
        case STATE_CONTRIBUTOR_IP:
            currentRevision.contributor_ip = currentRevision.contributor_ip || '';
            currentRevision.contributor_ip += text;
            break;
        case STATE_CONTRIBUTOR_USERNAME:
            currentRevision.contributor_username = currentRevision.contributor_username || '';
