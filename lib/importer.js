...
module.exports = {
    // can't really use the ip type until ES supports IPv6:
    // see https://github.com/elasticsearch/elasticsearch/pull/5758

    create: function (indexName, cb) {
